oTech.service('WiFiPerformanceService',
    ['$http', '$rootScope', '$timeout', '$location', '$q', function ($http, $location, $rootScope, $timeout, $q) {
        var service = {};
        var token = sessionStorage.getItem("token");
        /*
            Function to get mobilePerformance
        */

        /*
                 Function to get mobile performance data
                 */
        service.mobilePerformance = function (userId, pageIndex) {
            //alert(oApp.config.DASHBOARD_REPORTING_BASE_URL + "rest/dashboard/wifiPerformance")
            var deferred = $q.defer();
            // var datas=JSON.stringify(data);
            $.ajax({
                url: oApp.config.DASHBOARD_REPORTING_BASE_URL + "rest/dashboard/mobilePerformance",
                type: "POST",
        ...
        /*
        Function to get wifi performance data
        */
        service.wifiPerformance = function (userId, pageIndex) {
            var deferred = $q.defer();
            // var datas=JSON.stringify(data);
            // alert(oApp.config.DASHBOARD_REPORTING_BASE_URL + "rest/dashboard/wifiPerformance")
            $.ajax({
                url: oApp.config.DASHBOARD_REPORTING_BASE_URL + "rest/dashboard/wifiPerformance",
                type: "POST",
                data: { userId: userId , pageIndex: pageIndex},
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
   ...
   */
        ...
        service.showWiFiPerformanceMap = function (centerInfo, mobilePerformanceDataList) {
            var markers = [];
            ...
            for (var index = 0; index < mobilePerformanceDataList.length; index++) {
                ...
                (function (marker, mobilePerformanceDataList) {
                ...
                })(marker, mobilePerformanceDataList);
            }
