...
oApp.config = {
    ...
    columnDefsvoice: [
        ...
        {
            headerName: "voiceCallDeviceLocalTime",
            field: "voiceCallDeviceLocalTime",
            cellTooltip: function (row, col) {
    ...
    columnDefsvideo: [
        ...
        {
            headerName: "mplayerTotalFileDuration",
            field: "mplayerTotalFileDuration",
            cellTooltip: function (row, col) {
    ...
    columnDefsaudio: [
        ...
        {
            displayName: "FTP Server Wave File Path",
            width: 100,
            field: "ftpServerWaveFilePath",
            cellTooltip: function (row, col) {
    ...
    addUsergroupsGridOptions: {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                field: 'createdDate',
                width: "30%",
                cellFilter: "date:'" + oApp.constant.GRID_DATE_TIME_FORMAT + "'",
                cellTooltip: function (row, col) {
...
//		paginationPageSizes: [1,25, 50, 75],
    ...
    myDevicesGridOptions: {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                enableColumnMenu: false,
                enableSorting: false,
                cellTemplate: '<span class="pointer-link"   ng-click="grid.appScope.deviceAvailabilityBody(row);"><i class="pt icon-circle-right2 text-orange-600"></i></span>'
            },
            /* '<ul class="icons-list">'+
             '<li class="dropdown">'+
             '<a  class="dropdown-toggle" data-toggle="dropdown">'+
            ...
            {
                displayName: 'Job Start Date Time',
                field: 'jobStartDate',
                width: "20%",
                enableCellEdit: false,
                cellTooltip: function (row, col) {
            ...
            {
                displayName: 'Device HeartBeat Status',
    ...
    columnDefAlertHBDevice: [
        ...
        {field: 'xParam', displayName: 'X Param', enableCellEdit: true,visible:false ,},
        {field: 'yParam', displayName: 'Y Param', enableCellEdit: true,visible:false ,},
        {field: 'moving', displayName: 'Moving', enableCellEdit: true,visible:false ,},
        {field: 'highlight', displayName: 'HighLight', enableCellEdit: true,visible:false ,},
        ...
        {field: 'gsm', displayName: 'GSM', enableCellEdit: true,},
