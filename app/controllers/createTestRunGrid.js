            ...
            columnDefs: [
                {
                    field: 'testrunId',
                    name: 'Test Run Id',
                    headerCellClass: $scope.highlightFilteredHeader/*,width: '10%'*/
                },
                {
                    field: 'testrunName',
                    name: 'Test Run Name',
                    headerCellClass: $scope.highlightFilteredHeader/*,width: '20%'*/
                },
                {
                    field: 'taskId',
                    name: 'Task Id',
        ...
        $scope.ScheduleRealDevices = {
            ...
            columnDefs: [
                ...
                /* {field: 'notificationStatusName', name: ' Request status', headerCellClass: $scope.highlightFilteredHeader, cellTemplate:'<div data-toggle="modal" data-target="#DeviceNotification_List" ng-click="grid.appScope.showDeviceNotificationLogDetails({{row.entity.deviceId}},{{row.entity.jobId}});">'+'<a>{{row.entity.notificationStatusName}}</a>' +'</div>'},*/
                {
                    ...
                    name: 'Job Monitoring',
                    headerCellClass: $scope.highlightFilteredHeader,
                    cellTemplate: '<div class="ui-grid-progress-strip"><uib-progressbar animate="false" value=\"row.entity.jobProgress\" type="success"><b>{{row.entity.jobProgress}}%</b></uib-progressbar></div>'
                },
                 ...
                 {field: 'deviceLogLevel', name: ' Device Log Level', headerCellClass: $scope.highlightFilteredHeader},*/
                {
                    ...
                    enableSorting: false,
                    cellTemplate: '<select class="form-control" style=" border-color: #eaeaea;margin-left:7%;margin-top:2%;width: 80%;height:75%;padding-top:1%" ng-model="actions"  ng-change="grid.appScope.takeAction(this,row)">' +
